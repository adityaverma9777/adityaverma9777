...
# ===========================================================================
HOST = "adityaverma9777"

ROWS = [
    ("host",),
    ("kv", "Focus", "ML Systems & Inference Engineering"),
    ("kv", "Building", "Backend APIs that serve ML models"),
    ("kv", "Edu", "BCA — Computer Applications"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, TypeScript, Java, C++"),
    ("kv", "AI / ML", "PyTorch, Hugging Face, NumPy"),
    ("kv", "Backend", "FastAPI, PostgreSQL, Redis, MongoDB"),
    ("kv", "Frontend", "React, Next.js, Tailwind CSS"),
    ("kv", "Cloud", "Docker, Google Cloud, Git"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Exploring quantization & inference optimization"),
    ("bul", "Open-source beginner — learning backend & cloud"),
]
